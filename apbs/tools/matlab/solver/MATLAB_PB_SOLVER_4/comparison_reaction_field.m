...
disp('Welcome!!!!!!....')
disp(' ')
disp('This code will calculate the absolute error for the reaction field between')
...
%In the next four lines, please replace the name of the files by the one you have generated 

% reading electrostatic potential solvated state generated by MATLAB solver
MATLAB_pot_solv=data_parse('solvated-DNA_model_MATLAB_phi.dx',dime); 
% reading electrostatic potential solvated state generated by APBS
APBS_pot_solv=data_parse('solvated-DNA-pot.dx',dime); 
% reading electrostatic potential reference state generated by MATLAB solver
MATLAB_pot_ref=data_parse('ref-DNA_model_MATLAB_phi.dx',dime); 
% reading electrostatic potential reference state generated by APBS
APBS_pot_ref=data_parse('ref-DNA-pot.dx',dime); 
...
%diffe=(APBS_pot-MATLAB_pot)./APBS_pot;
...
name2= strcat('matlab_reaction_field','_and_','apbs_reaction_field');
subplot(1,2,1)
