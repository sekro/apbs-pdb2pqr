...
class pKaRoutines:
    ...
    def __init__(self, protein, routines, forcefield, apbs_setup, output_dir, maps = None, sd =None,
        ...
        self.output_files['titcurv_dat_file_path'] = os.path.join(self.output_dir, 'TITCURV.DAT')
    ...
    def calculatepKaValue(self):
        ...
        for i in range(3):
            ...
            delta = end - start
            delta_seconds = (delta.microseconds + (delta.seconds + delta.days * 24.0 * 3600.0) * 10.0**6) / 10.0**6
            mc_times = os.path.join(self.output_dir, 'mc_times.txt')
            with open(mc_times, 'a') as mc_times_file:
                mc_times_file.write(str(delta_seconds)+"\n")
        ...
        X.write_titration_curve(self.output_files['titcurv_dat_file_path'],
                                charges,
                                format='pdb2pka')
        #
